...
def serialize_features_and_classes(
    ...
    """
    f_path = f_name if output_directory is None else output_directory.joinpath(f_name+".pkl")  
...
if __name__ == "__main__":
    data_path = '/home/trann/scratch/TAU-urban-acoustic-scenes-2020-mobile/TAU-urban-acoustic-scenes-2020-mobile-development/'
    feature_extration(
        output_dev_path=Path('log_mel'), 
        output_test_path=Path('../features_128'),
        all_data_path='meta.csv',
        test_path='evaluation_setup/fold1_all.csv',
